...
class UserWatchlistWidget extends StatefulWidget {
  @override
  _UserWatchlistState createState() => _UserWatchlistState();
}

class _UserWatchlistState extends State<UserWatchlistWidget> {
  late Future<List<StockRecommendation>> _watchlist;
  ...
  _refreshWatchlist(BuildContext context) {
    try {
      final service = Provider.of<StockRecommendationService>(context, listen: false);
      _watchlist = service.getUserWatchlist();
      setState(() {});
    } catch (e) {
      print(e);
      return List.empty();
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.start, children: <Widget>[
          ...
          StockRecommendationDataTableBuilder(_watchlist, _filter)
        ]));
  }
}
